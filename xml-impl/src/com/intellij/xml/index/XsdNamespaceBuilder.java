...
public class XsdNamespaceBuilder extends NanoXmlUtil.IXMLBuilderAdapter implements Comparable<XsdNamespaceBuilder>
{
	...
	@Override
	public void startElement(@NonNls final String name, @NonNls final String nsPrefix, @NonNls final String nsURI, final String systemID, final int lineNr) throws Exception
	{
	...
	@Override
	public void addAttribute(@NonNls final String key, final String nsPrefix, final String nsURI, final String value, final String type) throws Exception
	{
	...
	public boolean equals(Object o)
	{
		...
		if(myNamespace != null ? !myNamespace.equals(builder.myNamespace) : builder.myNamespace != null)
		{
			return false;
		}
		if(myVersion != null ? !myVersion.equals(builder.myVersion) : builder.myVersion != null)
		{
			return false;
		}
		if(myTags != null ? !myTags.equals(builder.myTags) : builder.myTags != null)
		{
			return false;
		}
