...
public abstract class XmlTagRuleProviderBase extends XmlTagRuleProvider
{
	...
	{
		return new ConditionRule(ifAttrPresent(attrPresent), new InvalidAllExpectSome("The attribute is unused because the attribute " + attrPresent + " is present",
				ProblemHighlightType.LIKE_UNUSED_SYMBOL, ArrayUtil.append(attrUnused, attrPresent)));
	}
