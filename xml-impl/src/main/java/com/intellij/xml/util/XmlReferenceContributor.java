...
public class XmlReferenceContributor extends PsiReferenceContributor {
    ...
    public void registerReferenceProviders(@Nonnull final PsiReferenceRegistrar registrar) {
        ...
        PsiReferenceProviderByType commentsReference =
            PsiReferenceProviderByType.forType(CommentsReferenceContributor.COMMENTS_REFERENCE_PROVIDER_TYPE);
        ...
        XmlUtil.registerXmlAttributeValueReferenceProvider(
            ...
            true,
            new XmlBaseReferenceProvider(true)
        );

        registrar.registerReferenceProvider(
            xmlAttributeValue().withLocalName("base").withNamespace(XmlUtil.XML_NAMESPACE_URI),
        ...
        XmlUtil.registerXmlAttributeValueReferenceProvider(
            ...
            new ScopeFilter(new ParentElementFilter(new NamespaceFilter(XmlUtil.SCHEMA_URIS), 2)),
        ...
        registrar.registerReferenceProvider(
            xmlAttributeValue()
                .withLocalName("schemaLocation", "namespace")
                .withSuperParent(2, xmlTag().withNamespace(XmlUtil.SCHEMA_URIS).withLocalName("import", "include", "redefine")),
            uriProvider
        );
        ...
        registrar.registerReferenceProvider(
            xmlAttributeValue(),
            new XmlEnumeratedValueReferenceProvider(),
