...
import consulo.xml.descriptor.xsd.ComplexTypeDescriptor;
 ...
 * @author Mike
 */
public class ComplexTypeDescriptorImpl implements ComplexTypeDescriptor {
    protected final XmlNSDescriptorImpl myDocumentDescriptor;
    private final XmlTag myTag;

    private static final FieldCache<XmlElementDescriptor[], ComplexTypeDescriptorImpl, Object, XmlElement> myElementDescriptorsCache =
        new FieldCache<>() {

            protected XmlElementDescriptor[] compute(final ComplexTypeDescriptorImpl complexTypeDescriptor, final XmlElement p) {
                return complexTypeDescriptor.doCollectElements(p);
            }

            protected XmlElementDescriptor[] getValue(final ComplexTypeDescriptorImpl complexTypeDescriptor, final Object p) {
                return complexTypeDescriptor.myElementDescriptors;
            }

            protected void putValue(
                final XmlElementDescriptor[] xmlElementDescriptors,
                final ComplexTypeDescriptorImpl complexTypeDescriptor,
                final Object p
            ) {
    ...
    private static final FieldCache<XmlAttributeDescriptor[], ComplexTypeDescriptorImpl, Object, XmlElement> myAttributeDescriptorsCache =
        new FieldCache<>() {
            protected final XmlAttributeDescriptor[] compute(final ComplexTypeDescriptorImpl complexTypeDescriptor, XmlElement p) {
                return complexTypeDescriptor.doCollectAttributes(p);
            }

            protected final XmlAttributeDescriptor[] getValue(final ComplexTypeDescriptorImpl complexTypeDescriptor, Object o) {
    ...
    public ComplexTypeDescriptorImpl(XmlNSDescriptorImpl documentDescriptor, XmlTag tag) {
    ...
    private boolean _canContainTag(
        ...
        if (XmlNSDescriptorImpl.equalsToSchemaName(tag, "any")) {
            ...
            if (base != null) {
                ...
                if (descriptor instanceof ComplexTypeDescriptorImpl) {
                    ComplexTypeDescriptorImpl complexTypeDescriptor = (ComplexTypeDescriptorImpl)descriptor;
