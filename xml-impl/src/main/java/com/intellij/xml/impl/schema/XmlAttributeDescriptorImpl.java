...
public class XmlAttributeDescriptorImpl extends BasicXmlAttributeDescriptor implements PsiWritableMetaData {
    ...
    public String getDefaultValue() {
        return isFixed() ? myTag.getAttributeValue("fixed") : myTag.getAttributeValue("default");
    }
    ...
    public String getName(PsiElement context) {
        ...
        if (targetNs != null && (
            isQualifiedAttr || QUALIFIED_ATTR_VALUE.equals(rootTag.getAttributeValue("attributeFormDefault"))
                || attributeShouldBeQualified
        )) {
