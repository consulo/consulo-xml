 ...
 * @since 2007-08-13
 */
class PatternReference extends PsiReferenceBase.Poly<RncRef>
    implements Function<Define, ResolveResult>, LocalQuickFixProvider, EmptyResolveMessageProvider {
    ...
    public ResolveResult[] multiResolve(boolean incompleteCode) {
        ...
        Set<Define> set = DefinitionResolver.resolve(scope, getCanonicalText());
    ...
    public ResolveResult apply(Define rncDefine) {
        PsiElement element = rncDefine.getPsiElement();
    ...
    public PsiElement handleElementRename(String newElementName) throws consulo.language.util.IncorrectOperationException {
        ASTNode newNode = RenameUtil.createIdentifierNode(getElement().getManager(), newElementName);
    ...
    public Object[] getVariants() {
        ...
        return ContainerUtil.mapNotNull(
                map.values(),
                (Function<Set<Define>, Object>) defines -> defines.size() == 0
                    ? null
                    : defines.iterator().next().getPsiElement()
            ).toArray();
    }
    ...
    static class CreatePatternFix implements LocalQuickFix {
        ...
        public void applyFix(@Nonnull Project project, @Nonnull ProblemDescriptor descriptor) {
            ...
            RncGrammar scope = myReference.getScope();
            assert scope != null;
            ...
            SmartPsiElementPointer<RncDefine> p = SmartPointerManager.getInstance(project).createSmartPsiElementPointer(e);
            ...
            RncDefine d = p.getElement();
            assert d != null;

            RncElement definition = d.getPattern();
