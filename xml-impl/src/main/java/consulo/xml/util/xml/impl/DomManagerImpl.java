...
import consulo.xml.impl.internal.dom.DomSupportProviders;
...
public final class DomManagerImpl extends DomManager {
    ...
    public final <T extends DomElement> DomFileElementImpl<T> getFileElement(XmlFile file) {
        ...
        if (!DomSupportProviders.isSupported(file.getApplication(), file.getFileType())) {
            return null;
        }
    ...
    @Override
    @Nullable
    public AbstractDomChildrenDescription findChildrenDescription(final XmlTag tag, final DomElement parent) {
