 ...
 * @author peter
 */
public class DomTargetImpl extends DelegatePsiTarget implements DomTarget {
  private final DomElement myDomElement;
  private final TextRange myRange;
  private GenericDomValue myNameDomElement;

  private DomTargetImpl(DomElement domElement, PsiElement navigationElement, TextRange range, final GenericDomValue nameElement) {
  ...
  @Nullable
  public static DomTargetImpl getTarget(DomElement element) {
  ...
  @Nullable
  public static DomTargetImpl getTarget(DomElement element, GenericDomValue nameElement) {
    if (nameElement instanceof GenericAttributeValue) {
      ...
      if (length >= 2) {
        return new DomTargetImpl(element, attributeValue, new TextRange(1, length - 1), nameElement);
      }
    }
    ...
    return new DomTargetImpl(element, tag, XmlTagUtil.getTrimmedValueRange(tag), nameElement);
  }
  ...
  public boolean equals(Object o) {
    ...
    DomTargetImpl domTarget = (DomTargetImpl)o;
