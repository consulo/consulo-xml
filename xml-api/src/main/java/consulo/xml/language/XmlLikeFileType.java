...
public abstract class XmlLikeFileType extends LanguageFileType {
  ...
  @Override
  public @Nullable String getCharset(VirtualFile file, final byte[] content) {
    String charset = XmlCharsetDetector.extractXmlEncodingFromProlog(content);
    return charset == null ? CharsetToolkit.UTF8 : charset;
  }

  @Override
  public @Nullable Charset extractCharsetFromFileContent(final Project project, @Nullable final VirtualFile file, final CharSequence content) {
