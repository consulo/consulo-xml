...
public class DAnnotation {
     ...
     * Keyed by QName.
     */
    Map<QName,Attribute> attributes = null;
    ...
    public Attribute getAttribute( QName n ) {
        return attributes != null ? attributes.get(n) : null;
    }
    ...
    public Map<QName,Attribute> getAttributes() {
        return attributes != null ? Collections.unmodifiableMap(attributes) : Collections.<QName, Attribute>emptyMap();
    }
    ...
    public List<Element> getChildren() {
        return contents != null ? Collections.unmodifiableList(contents) : Collections.<Element>emptyList();
    }
}
