 ...
 * @author peter
 */
public abstract class DomTestCase extends LightPlatformTestCase
{
	...
	protected static <T extends DomElement> T createElement(final DomManager domManager, final String xml, final Class<T> aClass) throws IncorrectOperationException
	{
