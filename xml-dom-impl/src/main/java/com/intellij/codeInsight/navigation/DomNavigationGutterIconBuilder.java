...
public class DomNavigationGutterIconBuilder<T> extends NavigationGutterIconBuilder<T>
{
	...
	public static <T> DomNavigationGutterIconBuilder<T> create(@Nonnull final Image icon, @Nonnull NotNullFunction<T, Collection<? extends PsiElement>> converter)
	{
	...
	{
		if(!myLazy && myTargets.getValue().isEmpty() || element == null)
		{
			return null;
		}
